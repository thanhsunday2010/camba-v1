      ...
      overview={{
        ...
        labels: {
          ...
          leaderboards: {
            ...
            monthlyBoard: t("leaderboardsMonthly"),
            allTimeBoard: t("leaderboardsAllTime"),
            levelBoard: t("leaderboardsLevel"),
            streakBoard: t("leaderboardsStreak"),
            bestStreakBoard: t("leaderboardsBestStreak"),
            ...
            weeklyMeta: t("leaderboardsWeeklyMeta"),
            monthlyMeta: t("leaderboardsMonthlyMeta"),
            allTimeMeta: t("leaderboardsAllTimeMeta"),
            levelMeta: t("leaderboardsLevelMeta"),
            streakMeta: t("leaderboardsStreakMeta"),
            bestStreakMeta: t("leaderboardsBestStreakMeta"),
            tierNames: {
          ...
          streakRestore: {
            title: t("streakRestoreTitle"),
            description: t("streakRestoreDescription"),
            cta: t("streakRestoreCta"),
            pending: t("streakRestorePending"),
            insufficientXp: t("streakRestoreInsufficientXp"),
            daysLeft: t("streakRestoreDaysLeft"),
            error: t("streakRestoreError"),
          },
        },
      }}
    />
