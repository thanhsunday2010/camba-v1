    ...
    <StudentDashboardView
      ...
      labels={{
        ...
        achievements: {
          ...
          emptyAction: t("achievementsEmptyAction"),
        ...
        streak: {
          ...
          todayLabel: t("streakToday"),
          noStreakYet: t("streakNoStreakYet"),
        },
        mockTests: {
          title: t("mockTests"),
