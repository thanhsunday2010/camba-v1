...
import { MockPageClient } from "@/components/admin/assessments/mock-page-client";
...
export default async function AdminMockPage() {
  ...
  return (
    <div>
      <AdminPageHeader
        breadcrumb="Admin › Bài kiểm tra › Mock"
        title="Mock test"
      />
      <MockPageClient content={content} mockTests={assessments.mockTests} />
    </div>
  );
}
