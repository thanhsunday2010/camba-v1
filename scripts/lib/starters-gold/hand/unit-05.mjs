  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        pictureDescription: "Window showing rain and clouds; teddy and doll on a table.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          pictureDescription: "Rain on the window; children with a puzzle indoors.",
      ...
      },
      {
        ...
        check: {
          ...
          pictureDescription: "Sunny park with kite, ball and doll.",
