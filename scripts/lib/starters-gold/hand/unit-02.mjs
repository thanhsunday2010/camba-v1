  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        pictureDescription: "A child in a classroom with books on a desk.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          pictureDescription: "Child at desk with pencils.",
      ...
      },
      {
        ...
        check: {
          ...
          pictureDescription: "Calendar and classroom clock.",
