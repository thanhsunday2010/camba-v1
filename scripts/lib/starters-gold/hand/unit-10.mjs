  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        pictureDescription: "Street with house, park, shop, bus and car.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          pictureDescription: "Street scene with bus, bike, car and park.",
      ...
      },
      {
        ...
        check: {
          ...
          pictureDescription: "Map-like street with park, shop, school and house.",
