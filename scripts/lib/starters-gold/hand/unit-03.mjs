  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        sceneDescription: "Children in colourful clothes: red shirt, blue trousers, green dress, yellow shoes.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          sceneDescription: "Child in bedroom with shirt, trousers, shoes and hat on a chair.",
      ...
      },
      {
        ...
        check: {
          ...
          sceneDescription: "Clothes shop with dresses, jackets, shirts and shoes on display.",
