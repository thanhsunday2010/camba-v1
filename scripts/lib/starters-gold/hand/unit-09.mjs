  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        sceneDescription: "Children playing football, swimming and riding bikes.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          sceneDescription: "Sports field with football, tennis and swimming pool.",
      ...
      },
      {
        ...
        check: {
          ...
          sceneDescription: "Children with ball, bike and tennis racket after school.",
