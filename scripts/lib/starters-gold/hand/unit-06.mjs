  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        pictureDescription: "School lunch tray with rice, chicken, fruit and milk.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          pictureDescription: "School canteen with rice, chicken, fruit and milk.",
      ...
      },
      {
        ...
        check: {
          ...
          pictureDescription: "Breakfast table with egg, bread, apple and milk.",
