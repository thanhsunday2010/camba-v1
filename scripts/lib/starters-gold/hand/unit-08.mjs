  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        sceneDescription: "Classroom with desks, bags, books and a teacher.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          sceneDescription: "School desk with bag, book, pen and pencil.",
      ...
      },
      {
        ...
        check: {
          ...
          sceneDescription: "Scenes of a farmer on farm and worker building a house.",
