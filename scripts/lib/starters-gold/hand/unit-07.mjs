  ...
  lesson0ExtraSpecs: {
    ...
    speaking: {
      ...
      check: {
        ...
        sceneDescription: "A bedroom with bed, lamp, chair, bag and books.",
    ...
    speaking: [
      null,
      {
        ...
        check: {
          ...
          sceneDescription: "Bedroom with bag on a chair and shoes under a bed.",
      ...
      },
      {
        ...
        check: {
          ...
          sceneDescription: "House cutaway showing kitchen, bedroom and living room.",
